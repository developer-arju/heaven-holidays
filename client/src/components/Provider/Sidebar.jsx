...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-50 flex h-screen w-56 flex-col overflow-y-hidden bg-emerald-800 text-neutral-200  duration-300 ease-linear lg:static lg:translate-x-0 ${
