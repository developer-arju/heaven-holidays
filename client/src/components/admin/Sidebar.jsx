...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-30 flex h-screen w-56 flex-col overflow-y-hidden bg-cyan-800 text-neutral-200  duration-300 ease-linear lg:static lg:translate-x-0 ${
        sidebarOpen ? "translate-x-0" : "-translate-x-full"
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-4 lg:ps-6 py-6">
        <NavLink to="/admin">
          <Logo />
        </NavLink>
        <button
      ...
      <div className="flex flex-col overflow-y-auto duration-300 ease-linear invisible-scrollbar">
        ...
        <nav className="mt-5 py-4 px-4 lg:m-0  lg:px-6 font-tabs">
          {/* <!-- Menu Group --> */}
          <div>
            <ul className="mb-6 flex flex-col gap-1.5 invisible-scrollbar">
              {/* <!-- Menu Item Dashboard --> */}
              <li>
                <NavLink
                  to="/admin"
                  className={`group relative flex items-center gap-2.5 py-2 px-4 font-medium duration-300 ease-in-out ${
                    pathname === "/admin" && "bg-white text-black rounded-full"
                  }`}
                >
                  <svg
                    className="fill-current"
